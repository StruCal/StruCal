...
trainLoadImagePathFactory[TrainLoadType.HSLMA] = '/Scripts/TrainLoad/dist/assets/HSLM-A.svg';
trainLoadImagePathFactory[TrainLoadType.HSLMB] = '/Scripts/TrainLoad/dist/assets/HSLM-B.svg';
