...
namespace CalculatorsTests.ConcreteCover
{
    ...
    public class StructuralClassTests
    {
        ...
        [TestCase("12", StructuralClass.S6, false, ExposureClass.X0, ConcreteClass.C90_105, false, false, StructuralClass.S5)]
        [TestCase("Designers' guide to Eurocode 2: Design of concrete structures. Part 2: Concrete bridges", StructuralClass.S4, true, ExposureClass.XC3, ConcreteClass.C40_50, true, false, StructuralClass.S4)]
